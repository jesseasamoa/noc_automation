...
call_api.py : Shadowserver Foundation API Utility
...
This script may be called with two or three arguments:
    ...
    call_api.py <method> <request> [pretty|binary]

The request must be a valid JSON object.

Simple usage:

$ ./call_api.py test/ping '{}'
{"pong":"2020-10-26 23:06:37"}

Pretty output:

$ ./call_api.py test/ping '{}' pretty
{
...
if __name__ == '__main__':
    ...
    if (len(sys.argv) < 3):
        exit("Usage: call_api.py method json [pretty|binary]")
